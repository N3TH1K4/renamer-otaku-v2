...
async def ForceSub(bot: Client, event: Message):
    """
    Custom Pyrogram Based Telegram Bot's Force Subscribe Function by @Friend_A_Kousei.    
    ...
    try:
        ...
        await bot.send_message(
            chat_id=event.from_user.id,
            text="**This bot is run on Heroku🙂.. So to prevent crashing, only channel subscribers can use this bot.. \n\nIf you want to use this bot, please join updates channel😇..",
